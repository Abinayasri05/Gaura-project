...
from kivy.graphics.vertex_instructions import platform
...
class MainWidget(RelativeLayout):
    ...
    V_NB_LINES = 8
    V_LINES_SPACING = .50 # percentage in screen width
    vertical_lines = []
    ...
    menu_title = StringProperty(" G   A   U   R   A   2  .  0")
    ...
    def init_audio(self):
        ...
        self.sound_gameover_impact = SoundLoader.load("audio/mixkit-long-game-over-notification-276.wav")
        self.sound_gameover_voice = SoundLoader.load("audio/gameover_voice.wav")
        self.sound_music1 = SoundLoader.load("audio/mixkit-arcade-rising-231.wav")
        self.sound_music2 = SoundLoader.load("audio/Like An Echo In The Forest - English.mp3")
